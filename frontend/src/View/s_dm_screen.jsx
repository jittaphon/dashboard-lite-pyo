...
const fetchData = async () => {
  try {
    ...
    const response = await API.dmApi.getDM_ScreenAppointments(params);
        ...
        <div className="max-w-[1600px] mx-auto">
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <h1 className="text-3xl font-bold text-gray-800">ร้อยละของประชากรอายุ 35 ปีขึ้นไปที่ได้รับการคัดกรองเพื่อวินิจฉัยเบาหวาน</h1>
            </div>
...
<div className="space-y-6">
  ...
  <div className="bg-gradient-to-br from-teal-400 to-teal-600 rounded-2xl p-6 mb-7 text-white shadow-sm border border-teal-300">
    ...
    <p className="text-teal-50 text-base leading-relaxed">
      ติดตามและวิเคราะห์ข้อมูลการคัดกรองโรคเบาหวาน(HT)ในเขตสุขภาพที่ 1 
